...
import static org.apache.jackrabbit.oak.segment.azure.v8.ToolUtilsV8.newSegmentNodeStorePersistence;
...
public class AzureSegmentStoreExplorerBackend extends AbstractSegmentTarExplorerBackend {
    ...
    public void open() throws IOException {
        this.persistence = newSegmentNodeStorePersistence(ToolUtilsV8.SegmentStoreType.AZURE, path, azureStorageCredentialManagerV8);
