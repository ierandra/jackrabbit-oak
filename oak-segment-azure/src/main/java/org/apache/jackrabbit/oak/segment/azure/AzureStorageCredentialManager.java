...
public class AzureStorageCredentialManager {
    private static final Logger log = LoggerFactory.getLogger(AzureStorageCredentialManager.class);

    public BlobContainerClient getStorageCredentialsFromEnvironment(@NotNull String accountName, @NotNull Environment environment) {
    ...
    public BlobContainerClient getStorageCredentialAccessTokenFromServicePrincipals(String accountName, String clientId, String clientSecret, String tenantId) {
